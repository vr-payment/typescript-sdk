# VRPayment TypeScript SDK

- API version: 

The VRPayment TypeScript SDK is used to interact with VRPayment's REST API.
...
export const HttpBearerAuthConfig =
    new HttpBearerAuth(
        140366,
        "dvZsZdp+CLyi6RqBJuJER88CrrROHLz3VNuAkZI5U6s=");
...
When working with webhooks, the `VRPaymentSdkException` may throw error codes to help with debugging.
